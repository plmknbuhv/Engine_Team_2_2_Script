...
{
    public class UIShakeFeedback : MonoBehaviour, IUIFeedback
    {
        ...
        private async void Start()
        {
            ...
            {
                Debug.LogError($"Error initializing UIShakeFeedback: {e.Message}");
            }
        }
        ...
        public void Play()
        {
            ...
            _target.DOShakeAnchorPos(duration, magnitude);
        }
    }
}